                                    ...
                                    <div x-data="{ flip: false }" 
                                        ...
                                        <div :class="flip ? 'rotate-y-180' : ''"
                                            ...
                                            <div aria-title="Front"
                                                ...
                                                class="absolute inset-0 overflow-auto bg-white p-4 pb-20 [backface-visibility:hidden]">
                                                <div>
                                                    FRONT
                                                </div>
                                            </div>
                                            ...
                                            <div aria-title="Back"
                                                x-on:click="flip = !flip"
                                                class="text-slate-200 rotate-y-180 absolute inset-0 h-full w-full rounded-xl bg-white p-4 [backface-visibility:hidden] lg:text-center">
                                                <div>
                                                    BACK
                                                </div>
                                            </div>
