<div class="bg-gray-100">
    ...
    <header class="flex justify-between px-6 py-3 bg-white lg:px-16 lg:py-6">
        <h1 class="text-2xl font-bold leading-7 text-darkgreen sm:leading-9 lg:text-4xl">Question Banks</h1>
        <div>
            ...
            <div class="p-6 bg-white rounded-md">
                ...
                <div class="grid grid-cols-2 gap-4 mt-4 lg:grid-cols-3">
                    <div class="p-4 bg-pink-100 rounded-md">
                        ...
                        <h2 class="mt-3 text-xl font-bold">{{ number_format($widget_correct) }}%</h2>
                    ...
                    <div class="hidden p-4 bg-green-100 rounded-md lg:block">
