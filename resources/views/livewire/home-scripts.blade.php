    ...
    <div class="px-8 py-12 bg-gray-100 lg:px-16">
        ...
        <section class="py-16 bg-gray-200">
            <div class="text-center">
                ...
                <div class="mt-6">
                  <button x-data x-on:click="$dispatch('openmodal-create')" type="button" class="inline-flex items-center px-3 py-2 text-sm text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
